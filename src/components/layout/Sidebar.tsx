    ...
    <>
      ...
      <aside className="hidden lg:flex flex-col fixed inset-y-0 left-0 w-56 z-40 border-r border-carbon-500 bg-carbon-900">
        ...
        <div className="flex items-center gap-3 px-5 py-5 border-b border-carbon-500">
          <div className="flex items-center justify-center w-8 h-8 bg-blue-500 rounded-sm">
          ...
          {NAV.map(({ to, icon, label }) => (
            ...
            >
              {({ isActive }) => (
                <>
                  {isActive && (
                    <span className="absolute inset-y-0 left-0 w-0.5 bg-blue-500 rounded-r-full" />
                  )}
        ...
        {NAV.map(({ to, icon, label }) => (
          <NavLink
            ...
            className={({ isActive }) =>
              ...
              ${isActive ? 'text-blue-500' : 'text-carbon-200'}`
            }
          >
